class DynamicArray:
    def __init__(self) -> None:
        self._n_items = 0  # current item number in the array
    ...
    def append(self, new_element: int) -> list:
        ...
        self._array[self._n_items] = new_element
        self._n_items += 1
    ...
    def insert_at(self, idx: int, new_element: int) -> None:
